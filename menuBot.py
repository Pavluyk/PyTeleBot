...
m_fun = Menu("Развлечения", buttons=["Случайный пользователь", "Прислать собаку", "Прислать лису", "Прислать анекдот", "Прислать фильм", "Угадай кто?", "Выход"], parent=m_main, module="fun")
